...
draw_buffer:
        dc.l    bitplane+BPLWIDTH*BPLHEIGHT*BPLCOUNT
...
OFFSNEXTCOPPER = OFFSCLBLOCKDRAW+4*255+8*BPLCOUNT*255+4
...
bitplane:
        DS.B BPLWIDTH*BPLHEIGHT*BPLCOUNT*2

	;Kind of outcommented
	IFEQ DUMMY-1
...
OFFSCLPALETTE = 54*2
OFFSCLPALETTELW = OFFSCLPALETTE+64*2 ;Todo fix offset
;OFFSBPLPOINTERS = OFFSCLPALETTE+512*2+14*2+64*2    +63*4 
OFFSBPLPOINTERS = OFFSCLPALETTE+526*4+4
OFFSCLBLOCKDRAW = OFFSBPLPOINTERS+32*2
OFFSNEXTCOPPER = OFFSCLBLOCKDRAW+(BPLCOUNT*8+4)*255+4
...
copperlist:
	...
	dc.w	$104,0	                 	; BplCon2
	IFEQ AGA-1
	dc.w	$108,BPLWIDTH-40-8               ; Bpl1Mod
	dc.w	$10a,BPLWIDTH-40-8               ; Bpl2Mod
	ELSE
	dc.w	$108,BPLWIDTH-40                 ; Bpl1Mod
	dc.w	$10a,BPLWIDTH-40                 ; Bpl2Mod
	ENDC
